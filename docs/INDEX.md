...
|---|---|
| [design.md](design.md) | Current thinking on how the library is put together — the split between library and game, and the key problems with how we plan to solve each |
